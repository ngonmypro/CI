<?
$servername = '192.168.2.26'; //\SQLEXPRESS'; //​กำ​หนดชื่อ​ server
$user = 'it1234'; //​กำ​หนดชื่อ​ user name ​ที่​จะ​ connect database
$pass = 'Y@ng1234'; //​กำ​หนด​ password ​ที่​จะ​ connect ​ไปที่​ database

//$servername = '192.168.1.92'; // Server จริง
//$user = 'sa'; // user จริง
//$pass = 'yongdb'; //password จริง

$databasename = 'axlab1'; //​กำ​หนดชื่อ​ database ​บน​ Microsoft SQL
